...
st.write("Klikk på objekter i kartet for å inkludere / ekskludere.")
...
with col_table:
    ...
    # Clean Columns
    cols = ["Inkluder", "Status", "Beskrivelse", "kategori", "avstand_meter", "trykk_kPa", "bygningstype"]
...
if st.button("Bekreft utvalg og gå videre", type="primary", width="stretch"):
